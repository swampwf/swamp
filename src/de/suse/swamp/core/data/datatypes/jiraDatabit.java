...
import de.suse.swamp.core.data.Databit;
...
public class jiraDatabit extends Databit {


    public jiraDatabit(String name, String desc, String value, Integer state) throws Exception {
