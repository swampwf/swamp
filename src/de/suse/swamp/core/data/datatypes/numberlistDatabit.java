 ...
 *
 * Copyright (c) 2008 Thomas Schmidt
...
/**
 * Databit holding multiple numbers. 
 *
 * @author Thomas Schmidt
 */

public class numberlistDatabit extends numberDatabit {
    

    public numberlistDatabit(String name, String desc, String value, Integer state) throws Exception {
